...
GROCERY_KEYWORDS = {
    ...
    "cream":        ["P021","P023","P025"],
    "cheese":       ["P021","P023"],
    "paneer":       ["P023","P030"],
    "amul":         ["P021","P023","P025","P030"],
    "pasteurised":  ["P021","P030"],
    "spread":       ["P021","P025"],
    "salted":       ["P021","P025","P003"],
    # ── Bakery ──
    "bread":        ["P001","P003","P132"],
    "biscuit":      ["P001","P002","P007"],
    ...
    "loaf":         ["P001","P003","P132"],
    "pav":          ["P001","P132"],
    "bakery":       ["P001","P003","P006","P132"],
    # ── Snacks ──
    "chips":        ["P011","P012","P018"],
    "snack":        ["P011","P015","P016"],
    "namkeen":      ["P015","P016","P017"],
    "cashew":       ["P002"],
    "nut":          ["P002","P016"],
    "popcorn":      ["P011","P016"],
    "wafer":        ["P011","P012"],
    "lays":         ["P011","P012"],
    "kurkure":      ["P015","P016"],
    "haldiram":     ["P015","P016","P017"],
    "bingo":        ["P011","P012","P018"],
    "cracker":      ["P001","P002","P007"],
    "pretzel":      ["P007","P016"],
    # ── Noodles ──
    "noodle":       ["P051","P052","P057","P131"],
    "maggi":        ["P051","P131"],
    "pasta":        ["P055","P056","P060"],
    "spaghetti":    ["P055","P056"],
    "ramen":        ["P051","P052","P131"],
    "instant":      ["P051","P131"],
    ...
    "basmati":      ["P031","P032"],
    # ── Spices & Condiments ──
    "masala":       ["P041","P042","P047","P051","P131"],
    "spice":        ["P041","P042","P047"],
    "salt":         ["P003","P041"],
    "oil":          ["P049","P050"],
    "sauce":        ["P071","P080"],
    "ketchup":      ["P071","P080"],
    ...
    "mustard":      ["P041","P042"],
    # ── Beverages ──
    "tea":          ["P121","P122","P125","P126"],
    "coffee":       ["P123","P124","P127"],
    "juice":        ["P061","P062","P063"],
    "drink":        ["P061","P062","P121","P123"],
    "beverage":     ["P061","P062","P121","P123"],
    "shake":        ["P061","P062","P063"],
    "smoothie":     ["P061","P062","P063"],
    "espresso":     ["P123","P124"],
    # ── Fruits ──
    "banana":       ["P062","P063","P137"],
    "apple":        ["P062","P137"],
    "mango":        ["P062","P063","P066"],
    "orange":       ["P061","P063"],
    "fruit":        ["P061","P062","P063","P137"],
    "grape":        ["P062","P063"],
    "strawberry":   ["P062","P063"],
    "pineapple":    ["P062","P063"],
    "lemon":        ["P061","P063"],
    "watermelon":   ["P062","P063"],
    "pomegranate":  ["P062","P063","P137"],
    "papaya":       ["P062","P063"],
    # ── Personal Care ──
    "soap":         ["P083","P084"],
    "shampoo":      ["P085","P086"],
    "toothpaste":   ["P081"],
    "toothbrush":   ["P081","P082"],
    "lotion":       ["P087","P088"],
    "deodorant":    ["P089","P090"],
    "facewash":     ["P085","P087"],
    "sanitizer":    ["P083","P084"],
    # ── Home Care ──
    "detergent":    ["P101","P102"],
    "cleaner":      ["P101","P102","P103"],
    "dishwash":     ["P103","P104"],
    "floor":        ["P103","P104"],
    # ── Health ──
    "vitamin":      ["P111","P112"],
    "supplement":   ["P111","P112"],
    "protein":      ["P111","P112"],
    "tablet":       ["P111","P112"],
    # ── Chocolate & Sweet ──
    ...
    "toffee":       ["P006","P007"],
    # ── Generic visual tags ──
    "packet":       ["P011","P015","P051","P131"],
    "envelope":     ["P051","P131"],
    "bottle":       ["P049","P061","P062"],
    "can":          ["P061","P062","P063"],
    "box":          ["P001","P031","P051"],
    "container":    ["P023","P025","P049"],
    "yellow":       ["P051","P062","P063","P131"],
    "red":          ["P041","P071","P011"],
    "green":        ["P033","P041","P049"],
    "white":        ["P021","P030","P035"],
    "food":         ["P061","P062","P063"],
    "vegetable":    ["P041","P049","P033","P034"],
    "ripe":         ["P062","P063","P137"],
    "fresh":        ["P021","P023","P062"],
    "organic":      ["P033","P035","P049"],
    "natural":      ["P077","P096","P062"],
}
